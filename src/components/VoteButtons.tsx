...
export default function VoteButtons({ 
  ...
  const handleVote = async (value: number) => {
    ...
    // Store original state to revert if there's an error
    ...
    try {
      ...
      // Use the centralized votes endpoint instead of post/comment specific ones
      ...
      // Refresh the page to update UI with latest data
      router.refresh();
  ...
  // Get appropriate classes for upvote button
  ...
  // Get appropriate classes for downvote button
